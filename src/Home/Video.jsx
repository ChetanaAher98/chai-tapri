    ...
    return (
        <>
            ...
            <div style={bg} data-aos="fade-up">
                <div className='text-5xl font-bold  text-center textWithStrok py-5'>Our Stories</div>
                <div style={main} className='-mt-10'>
                    <iframe
                        width="1000"
                        height="450"
            ...
            <div className="container px-28 py-10 my-10 " >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 shadow-lg">
                    {/* <div> */}
                   
                    <div className="p-4 ">
                    <h1 className="text-2xl font-bold  text-center mb-4">What is a chai tapri?</h1>
                   <p className="text-gray-500 font-2xl">Tapri (tea stall) is a term used for a spot where people gather to share stories, conversations, and make memories, all while sipping a warm cup of chai.</p>
                    </div>
                    {/* </div> */}
                    <div>
                        <img src={chai} alt="Chai Tapri" className="object-cover " />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 my-10 shadow-lg py-10 gap-4">
                    <div >
                       <center> <img src={chaitapri} alt="Arpit Raj - Chaai Seth" className="object-cover  " style={{height:"300px",width:"300px",...internal}} /></center>
                    </div>
                    <div className="p-4">
                        <h1 className="text-2xl font-bold mb-4">Who is the owner of Chai Tapri?</h1>
                        <p className="text-gray-500 font-2xl">Arpit Raj, the founder of Chaai Seth holds a BBA in Travel, Tourism & Hospitality, and an MBA degree in Marketing. The co-founder Prateek too is an MBA-Finance grad and worked with KPMG. Arpit Raj started the "chai" concept back in 2015 in Shillong.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1">
                    <div className="p-4">
                        <h1 className="text-2xl font-bold mb-4">How it all started</h1>
